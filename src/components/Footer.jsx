  ...
  return (
    <div className='py-10 md:px-20 px-10 bg-violet-900 md:grid grid-cols-[repeat(1,2fr)_repeat(2,1fr)_repeat(1,2fr)] text-white'>
      ...
      <div>
        ...
        <p className='mt-6 text-justify'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Hic fuga ad, doloremque magnam, recusandae labore molestiae natus quibusdam ullam itaque eligendi nulla perferendis corporis fugit. Excepturi magni corporis labore iusto.</p>
      </div>
